...
- **Exercise**: 训练动作，归属于某个或多个 BodyPart（v1.4.5 支持多部位）
...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v1.5.0** | 2026-02-24 | Plan页执行计划功能 |
| **v1.4.5** | 2026-02-24 | 训练动作多部位支持 |
| **v1.4.4** | 2026-02-24 | Plan页重名计划检测 |
| **v1.4.0** | 2026-02-23 | Analysis页面热力图重构 |
| **v1.3.0** | 2026-02-23 | AppFlowy UI Beta 版发布 |
